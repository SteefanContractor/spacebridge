...
train_features = Xres.sample(frac=0.65, random_state=42)
...
# %%
# load lgbm model
lgbm_clf = pickle.load(open('../products/models/train_gradboost/lgbm_clf_4class_cleanSMOTEdata_20240508:082525.pkl', 'rb'))
# %%
